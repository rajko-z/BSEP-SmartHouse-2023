...
public class BackApplication implements CommandLineRunner {
	...
	private void createCSRRequests() {
		csrRequestRepository.save(new CSRRequest(11111111L, "test1@gmail.com", "test1", "test1"));
		csrRequestRepository.save(new CSRRequest(22222222L, "test2gmail.com", "test2", "test2"));
	}

	private void createUsers() {
		userRepository.save(new User("test1@gmail.com", "Test1", "Test1"));
		userRepository.save(new User("test2@gmail.com", "Test2", "Test2"));
		userRepository.save(new User("test3@gmail.com", "Test3", "Test3"));
	}
}